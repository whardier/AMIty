...
if __name__ == "__main__":
    ...
    amity.client.Request(action='Login', secret='awesome', username='hithere')
    print amity.client.Request(action='Login', secret='awesome', username='hithere').urlencode()
    print amity.client.Request(action='Login', secret='awesome', username='hithere').amiencode()
